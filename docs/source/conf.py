#!/usr/bin/env python
#
# duck documentation build configuration file, created by
...
# Add duck to sys.path to avoid having to full
# install duck for autodoc.
# Full install of duck will burst memory limit on ReadTheDocs.
...
project = "Duck"
copyright = "2022, Carsten Ehbrecht"
